...
<div id="page-wrapper">
    <div class="col-xs-10 col-sm-8 col-md-6">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Edit Login password</h1>
            </div>
        </div>

        <form class="form-horizontal" id="info-info-panel" action="/pwdManager/pwdManager/index.php/Customer/Profile/editPrimary" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="info-name" class="col-sm-5 control-label">Safety password</label>
                <div class="col-sm-7">
            ...
            <div class="form-group">
                <label for="info-password" class="col-sm-5 control-label">New Login Password</label>
                <div class="col-sm-7">
                    <input type="password" class="form-control" name="password" id="info-password" placeholder="Enter new login password" value="" required>
                </div>
            </div>
            <div class="form-group">
