...
<div id="page-wrapper">
    <div class="col-xs-10 col-sm-8 col-md-6">
        ...
        <form class="form-horizontal" id="info-info-panel" action="/pwdManager2/pwdManager/index.php/Customer/Password/edit" method="post" enctype="multipart/form-data">
            ...
            <input style="display: none" type="number" name="pwd_id" id="pwd_id" value="<?php echo ($info["pwd_id"]); ?>">
            ...
            <div class="form-group">
                <label for="info-password" class="col-sm-3 control-label">New Password</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" name="password" id="info-password" placeholder="The content of your password(like '123456a')" value="" required>
                </div>
            </div>
            <div class="form-group">
