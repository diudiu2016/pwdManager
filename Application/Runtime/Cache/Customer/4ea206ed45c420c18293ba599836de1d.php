...
<div id="page-wrapper">
    ...
    <div class="form-group col-sm-11">
        <div class="col-sm-3 col-sm-offset-9">
            <a href="/pwdManager2/pwdManager/index.php/Customer/Password/add"
            ...
            <?php if(is_array($data["list"])): $k = 0; $__LIST__ = $data["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                    ...
                    <td>
                        ...
                        <a role="button" class="btn btn-default btn-xs"
                                 href="/pwdManager2/pwdManager/index.php/Customer/Password/read/pwd_id/<?php echo ($vo["password_id"]); ?>">read</a>
                    </td>
                    <td>
                        <a role="button" class="btn btn-default btn-xs"
                                 href="/pwdManager2/pwdManager/index.php/Customer/Password/edit/pwd_id/<?php echo ($vo["password_id"]); ?>">edit</a>
                        <button type="button" class="btn btn-danger btn-xs delete" data-item="<?php echo ($vo["item"]); ?>"
                                data-id="<?php echo ($vo["id"]); ?>" href="/pwdManager2/pwdManager/index.php/Customer/Password/delete/pwd_id/<?php echo ($vo["password_id"]); ?>">delete</button>
                    </td>
